...
public class QtypeDaoImpl implements QtypeDao{
	...
	@Override
	public Long insert(Qtype bean)  {
		   java.sql.Connection conn=null;
		   PreparedStatement stmt=null;
		   Integer num=0;
	 	   conn = DbPub.getConn();
		   String sql="insert into qtype (qtypename)values(?)";
		   List<Object> paramsList = new ArrayList<Object>();
		   paramsList.add(bean.getQtypeName());
	...
	public Long delete(Long id) {
		   ...
		   Integer num=0;
	 	   conn = DbPub.getConn();       
		   String sql="delete from qtype where QtypeId= ? ";
		   List<Object> paramsList = new ArrayList<Object>();
		   paramsList.add(id);
		    Object[] params = paramsList.toArray();	   
		    num=DbPub.update(conn, sql, params);
	...
	public Long update(Qtype bean) {
		 java.sql.Connection conn=null;
		   ...
		   Integer num=0;
	 	   conn = DbPub.getConn();
		   String sql="update qtype set qtypename=? where QtypeId = ?";
	...
	public List<Qtype> list() {
		...
		return (List<Qtype>) bean;
	}
	private Qtype toBean(ResultSet rs) throws SQLException{
		Qtype bean= new Qtype();
	    bean.setQtypeId(rs.getInt("QtypeId"));
        bean.setQtypeName(rs.getString("qtypename"));
		return bean;	
	}
	...
	public Long count() {
		...
		String sql="select count(1) from qtype where 1=1";
	...
	public Long countByName(String name) {
		...
		Long num=0l;
		List<Object> list=new ArrayList<>();
		String sql="select count(1) from qtype where bookname=?";
		Object[] params = list.toArray();
		num=DbPub.queryScalearLong(conn, sql, params);
		DbPub.closeConnection(conn);
		return num;
	...
	public Qtype load(Long id) {
		// TODO Auto-generated method stub
				...
				Qtype bean=null;
				 ...
				 ResultSet rs=null;
				 conn = DbPub.getConn();
				 String sql=("select * from qtype where QtypeId= ?");
				 List<Object> list=new ArrayList<Object>();
				 list.add(id);
				 Object[] params = list.toArray();
				 rs=DbPub.query(conn, sql,params);
	...
	public List<Qtype> listByName(String name) {
		  List<Qtype>bean1=new ArrayList<>();
		   java.sql.Connection conn=null;
		   ResultSet rs=null;
		   conn = DbPub.getConn();
		   String sql="select * from Qtype where qtypename like ? ";
		    List<Object> list=new ArrayList<Object>();
		    name="%"+name+"%";
			list.add(name);
			 Object[] params = list.toArray();
