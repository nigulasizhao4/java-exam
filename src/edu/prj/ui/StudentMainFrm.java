...
import edu.prj.ui.student.exam.ChooseFrm;
import edu.prj.ui.student.mark.*;





public class StudentMainFrm extends JFrame implements ActionListener{
	/**
	 * 
	 */
    ...
    JMenuItem exam1 = new JMenuItem("在线考试");
	...
	public StudentMainFrm(String name, Person person) {
		setName(name);
		setPerson(person);
		initUI();
		//bindEvent();
	  ...
	  @Override
	    public void actionPerformed(ActionEvent e) {
		  ...
		  if (e.getSource() == exam1) {
	            ChooseFrm frm = new ChooseFrm(name);
	        }
		  if (e.getSource() == query) {
            ExamFrm frm = new ExamFrm(name);
	        }
		  if (e.getSource() == qute) {
...
//          exam1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
//          qute.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, ActionEvent.CTRL_MASK));
//          exit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK));
//          query.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK));
//          
          system.add(change);
          system.add(qute);
          system.add(exit);
