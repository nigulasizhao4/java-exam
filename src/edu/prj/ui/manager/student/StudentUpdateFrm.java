...
public class StudentUpdateFrm extends JFrame implements ActionListener{
	...
	public Long update() throws SQLException {
		...
		IdText roomId1= (IdText) cboRoomId.getSelectedItem();
		 ...
		 bean1.setStudentid(pk.intValue());
		 ...
		 result = studentService.update(bean1);
		 }
		return result;
