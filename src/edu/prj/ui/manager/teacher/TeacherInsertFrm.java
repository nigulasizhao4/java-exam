...
public class TeacherInsertFrm extends JFrame implements ActionListener{
	...
	public Long insert() {
		 ...
		 teacherName=txtNickName.getText().trim();
		 userName = txtUserName.getText().trim();
		 userPass = txtUserPass.getText().trim();		 
		 if(SysFun.isNullOrEmpty(teacherName)) {
		 ...
		 Teacher bean = teacherService.loadName(userName);
		 if(bean!=null) {
		 ...
		 bean1.setIsdisabled(isdisabled);
		  ...
		  String errMsg=null;	  
		try {
			result = teacherService.insert(bean1);
