...
public class QuestionUpdateFrm extends JFrame implements ActionListener{
	...
	public QuestionUpdateFrm(Long qid){
	...
	public Long update() throws SQLException {
       ...
       if(bean.getqTypeId()==2) {
		 ...
		 bean1.setQuestionId(pk.intValue());
		 bean1.setqTypeId(bean.getqTypeId());
		 ...
		 bean1.setSubjectId(bean.getSubjectId());
		 bean1.setTag(tag);
       }
       if(bean.getqTypeId()==1) {
		  ...
		  Long result=0l;
		  String errMsg=null;	  
		result = questionService.update(bean1);
		return result;
